...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT(/*model*/ MODEL_WF_GIANT_POLE,     /*pos*/ -1498, 2560,  2510, /*angle*/ 0, 0, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvGiantPole),
...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT(/*model*/ MODEL_WHOMP,             /*pos*/ -1990, 2560,   624, /*angle*/ 0,    0, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvSmallWhomp),
...
const LevelScript level_wf_entry[] = {
    ...
    AREA(/*index*/ 1, mountain_geo),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  2600, 1360,  5120, /*angle*/ 0, 90, 0, /*bhvParam*/ BPARAM2(WARP_NODE_0A), /*bhv*/ bhvSpinAirborneWarp),
