ALIGNED8 static const Texture ccm_seg7_texture_areamap_top[] = {
#include "levels/ccm/areamap_snow_slider_top.rgba16.inc.c"
};

ALIGNED8 static const Texture ccm_seg7_texture_areamap_bottom[] = {
...
#include "levels/ccm/8.rgba16.inc.c"
};
